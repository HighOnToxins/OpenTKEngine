...
public class Mesh<V1, V2>: Mesh where V1 : unmanaged where V2 : unmanaged {
    ...
    public Mesh((V1 vertex1, V2 vertex2)[] vertices, params uint[] elements) : base(elements) {

        V1[] vertices1 = new V1[vertices.Length];
        V2[] vertices2 = new V2[vertices.Length];

        for(int i = 0; i < vertices.Length; i++) {
            vertices1[i] = vertices[i].vertex1;
            vertices2[i] = vertices[i].vertex2;
        }
